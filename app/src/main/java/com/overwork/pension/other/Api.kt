...
//val BASEURL = "http://10.3.240.138:8081/yly/appall"//基本
...
//val OVER_EX = "/savecgjl.action"//完成任务详情测量项
//val OVER_TASK = "/wczhrwx.action"//完成护理项
...
val T_ABNORMAL = "jb_ycxx"//交班——异常信息https://github.com/wwan12/AnalogInterface/blob/master/abnormalShift.json
