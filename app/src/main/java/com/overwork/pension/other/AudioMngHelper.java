...
public class AudioMngHelper {
    ...
    /**
     * 以0-100为范围，获取当前的音量值 * @return 获取当前的音量值
     */
    ...
    /**
     * 修改步进值 * @param step step * @return this
     */
    ...
    /**
     * 改变当前的模式，对全局API生效 * @param type * @return
     */
    ...
    /**
     * 改变当前FLAG，对全局API生效 * @param flag * @return
     */
    ...
    /**
     * 调整音量，自定义 * @param num 0-100 * @return 改完后的音量值
     */
    ...
    /**
     * 步进加，步进值可修改 * 0——100 * @return 改完后的音量值
     */
    ...
    /**
     * 步进减，步进值可修改 * 0——100 * @return 改完后的音量值
     */
